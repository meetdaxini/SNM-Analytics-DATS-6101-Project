...
Since the p-value `r ttest_result$p.value` is greater than 0.05, we fail to reject the null hypothesis. The mean credit scores of churned customers and non-churned customers are equal.
