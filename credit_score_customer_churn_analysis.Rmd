...
```{r}
ggplot(churn_data_filtered, aes(x = Age)) +
  geom_histogram(color="black",fill = "lightgreen") +
  labs(title = "Age of the Customers", x = "Age", y = "Count")
```

We can see that the majority of customers are between 20 and 50 years old, while relatively few customers are younger than 20 or older than 70.
